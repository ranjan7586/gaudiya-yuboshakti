...
class AuthController {
    async register(req, res) {
        try {
            ...
            const result = await AuthService_1.default.register(req);
    ...
    async login(req, res) {
        try {
            ...
            const result = await AuthService_1.default.login(req);
    ...
    async index(req, res) {
        try {
            ...
            const result = await AuthService_1.default.getUsers(page, display_per_page, sort_by, sort_order);
    ...
    async roleCheck(req, res) {
        try {
            const result = await AuthService_1.default.roleCheck(req.body?.auth_user?.id);
